...
// --- IMPORTANT ---
// This error is a file path issue. For this code to work, please ensure
// you have created the following folder and file in your project:
// FOLDER: src/context
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.token && response.data.user) {
        ...
        login(response.data.token, user.userType);
        localStorage.setItem("user", JSON.stringify(user));
        if (user.userType === "admin") {
          navigate("/admindashboard");
        } else {
          navigate("/searchinternships");
        }
      } else {
            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 sm:p-12 rounded-3xl shadow-2xl max-w-md text-center">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/200x60/e2e8f0/333?text=Logo";
                }}
              />
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-black bg-gray-100 border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  />
                </div>
                <div className="mb-6">
                  <label
